...
class LLMServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateStream = channel.unary_stream(
                '/theo.llm.LLMService/GenerateStream',
                request_serializer=llm__service__pb2.GenerateRequest.SerializeToString,
                response_deserializer=llm__service__pb2.StreamEvent.FromString,
                _registered_method=True)
...
def add_LLMServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GenerateStream': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=llm__service__pb2.GenerateRequest.FromString,
                    response_serializer=llm__service__pb2.StreamEvent.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'theo.llm.LLMService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('theo.llm.LLMService', rpc_method_handlers)
...
class LLMService(object):
    ...
    def GenerateStream(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            '/theo.llm.LLMService/GenerateStream',
            llm__service__pb2.GenerateRequest.SerializeToString,
            llm__service__pb2.StreamEvent.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
